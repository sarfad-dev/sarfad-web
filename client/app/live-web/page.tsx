			...
			<Box width="100vw">
				...
				<Box px={{ base: 4, md: 10 }} pt="4" pb="20">
					<SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} mt={10}>
						...
						<ChartDashboard type="humidity" label="Vlhkost (%)" color="royalblue" yAxisLabel="Vlhkost (%)" yAxisMin={0} yAxisMax={100}/>
						<ChartDashboard type="pressure" label="Atmosférický tlak (hPa)" color="orange" yAxisLabel="Tlak (hPa)" yAxisMin={800} yAxisMax={1500}/>
